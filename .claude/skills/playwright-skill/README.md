...
>
> This skill is based on [lackeyjb/playwright-skill](https://github.com/lackeyjb/playwright-skill).
> The following changes have been made for this project:
>
> - `run.js`: Changed package manager from npm to bun
>   - `npm install` → `bun install`
>   - `npx playwright install chromium` → `bunx playwright install chromium`
